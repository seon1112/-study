...
public class StudyDAO {
	...
	//스터디 생성
	public int insert(StudyVO s) {
		return DBManager.insertStudy(s);
	}
	
	//스터디 다음 번호 찾기
	public int getNextNo() {
		return DBManager.getNextNoStudy();
	}
	
	//스터디 상세보기
	public StudyVO findByNo(int no) {
		return DBManager.findByNoStudy(no);
	}
	
	//스터디 전체 찾기
	public List<StudyListVO> findAll(HashMap<String, Object> map){
		return DBManager.findAllStudy(map);
	}
