	    ...
	    function withdraw(){
	        ...
	        if (confirmation) {
	            $.ajax({
	                ...
	                success:function(data){
	                    if(data==0){
	                        alert("방장은 마이페이지에서만 탈퇴가 가능합니다");
	                    }else{
	                        alert("탈퇴 처리가 완료되었습니다.");
	                        location.href="myProPage";
	                    }
	                }
	            })
	        } else {
	            // 사용자가 취소를 선택한 경우 아무 작업 없이 창을 닫습니다.
	        }
	    }
	    // div 요소에 클릭 이벤트 핸들러를 등록합니다.
   ...
   <!-- 사이드 바 -->
    ...
    <div class="mystudy-3uT">
      <div class="maincol-CGZ">
        <div class="mainstudy-Wo3">  
          <div class="auto-group-c6cy-r6D">
           <div class="serch-gJm">
	          <div class="item-mr1">
	          <div>
	            <div class="studysearching-KsX">${studyName }</div>
        ...
        <div id="withdrawButton" class="item--yaZ" style="text-decoration: none; color: #868e96" onclick="withdraw()" >스터디 탈퇴</div>
      </div>
