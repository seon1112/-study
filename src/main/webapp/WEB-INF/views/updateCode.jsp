...
<body>
	...
	<div class="code-Ek1" id="content">
		<form action="/updateCode?ct_no=${ct_no }" method="post">
			<div class="maincol-Adf">
					...
					<div class="article-B2y">
						...
						<div class="auto-group-sehf-VSy">
							<div class="heading-2-EfT">
								...
								<input type="text" list="searchTitle" name="q_title" class="performancetext-Wss" value="${c.q_title }"/>
							...
							<div class="heading-3-4Pb">
								...
								<input type="text" name="p_timer" id="p_timer"
									...
									class="classtext-xjs" value="${c.p_timer }"/>
							</div>

							<div class="heading-3-4Pb">
								<!-- 문제 언어 -->
								<div class="class-2LR">문제 언어</div>
								<select name="p_lang" id="p_lang" class="classtext-xjs" value="${c.p_lang }">
						...
						<div class="heading-4-6bB">
							...
							<input type="text" name="p_link" class="questiontext-amF"
								style="font-size: 1.6rem;" value="${c.p_link }">
						</div>
				...
				<!-- 목록버튼 -->
				<input type="submit" class="listbtn-95b" value="수정">
			</div>
		</form>
	</div>
