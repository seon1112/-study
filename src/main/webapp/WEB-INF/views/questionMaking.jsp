        ...
        <div class="page-msF">
          <div class="auto-group-mhgv-uCm">
            <div class="section-r81">
              ...
              <div class="list-Dsf">
                <div class="item-muB">
                  ...
                  <input type="text" class="divselectcontrol-r9w" name="b_title" placeholder="질문제목을 입력하세요">
                    
                  
                </div>
                <div class="item-EwB">
                  <div class="label--nC1">문제 제목</div>
                  <input type="text" name="b_p_title"  class="divselectcontrol-hZs"  placeholder="문제제목을 입력하세요">
            ...
            <div class="section-Cf3">
              ...
              <textarea name="b_content" class="divql-container-pwK" placeholder="질문 내용을 입력하세요"></textarea>
              </div>
              ...
              <div class="divql-container-RLm">
                ...
                <textarea name="b_code" id="codeIn" class="divql-editor-aUZ" placeholder="코드를 입력하세요"></textarea>
				
				
              </div>
          <div class="section-BDT">
            <a href="/questionBoard" class="button-hhb">취소</a>
            <input type="submit" class="button-C8Z" value="글 등록">
          </div>
            </div>
          </div>
        </div>
