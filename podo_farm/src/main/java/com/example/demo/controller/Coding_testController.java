...
public class Coding_testController {
	...
	//문제 정보 
	@GetMapping("/codePage")
	public void codePage(String ct_no,Model model) {
	...
	public void code(String year,Model model,String mate_no) {
		...
		}else if(mate_no==null||mate_no.equals("")){
			mate_no2=null;
			//스터디 번호
