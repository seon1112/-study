...
<body>
	...
	<div class="sidbar-LMX">
		<div class="sidemenu-ggH">
			  <a href="myProPage?a_no=4" class="w3-bar-item w3-button" style="padding-top:15px; padding-bottom:15px;" >
			  My Programmars
			  </a>
			  <a href="myStudyPage?a_no=4" class="w3-bar-item w3-button" style="padding-top:15px; padding-bottom:15px;">
			  My Study
			  </a>
