	...
	<div class="sidbar-LMX">
		<div class="sidemenu-ggH">
			  <a href="#" class="w3-bar-item w3-button">
			   <img class="icon-ddT icon" src="./assets/icon-CiV.png"/>
			  My Programmars
			  </a>
			  <a href="#" class="w3-bar-item w3-button">
			  <img class="icon-pT3 icon" src="./assets/icon-xFb.png"/>
			  My Study
			  </a>
			      <button class="w3-button w3-block w3-left-align" onclick="myAccFunc()">
			      <img class="icon-2Z7 icon" src="./assets/icon.png"/>
			  ...
			  <a href="#" class="w3-bar-item w3-button">
			   <img class="icon-ZBf icon" src="./assets/icon-rf3.png"/>
			  Study
			  </a>
			  <a href="#" class="w3-bar-item w3-button">
			  <img class="icon-jVT icon" src="./assets/icon-xHf.png"/>
			  Board
			  </a>
	  	</div>
